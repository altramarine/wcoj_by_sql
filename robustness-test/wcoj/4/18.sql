...
CREATE TEMP TABLE node5_R2__R4__R5 AS SELECT node0_best.b as b, R2.c as c, node0_best.d as d FROM R2 JOIN node0_best ON node0_best.b = R2.b WHERE node0_best.tag = 1;
