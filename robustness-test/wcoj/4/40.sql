...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R3 as (SELECT a, COUNT(*) as cnt FROM R3 GROUP BY a),
  best_R3 as (SELECT node4_R1__R4.a as a, node4_R1__R4.b as b, node4_R1__R4.d as d, 0 as tag, cnt_R3.cnt as cnt FROM node4_R1__R4, cnt_R3 WHERE cnt_R3.a = node4_R1__R4.a),
...
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R3.c as c FROM R3 JOIN node4_best ON node4_best.a = R3.a SEMI JOIN R2 ON R2.b = node4_best.b AND R2.c = R3.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4__R5
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R2.c as c FROM R2 JOIN node4_best ON node4_best.b = R2.b SEMI JOIN R3 ON R3.a = node4_best.a AND R3.c = R2.c WHERE node4_best.tag = 1) node5_R1__R2__R3__R4__R5
);
