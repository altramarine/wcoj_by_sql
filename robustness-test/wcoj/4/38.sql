...
CREATE TEMP TABLE node0_best AS WITH
  ...
  best_R1 as (SELECT best_R2.a as a, best_R2.c as c, CASE WHEN best_R2.cnt < cnt_R1.cnt THEN best_R2.tag ELSE 1 END as tag,CASE WHEN best_R2.cnt < cnt_R1.cnt THEN best_R2.cnt ELSE cnt_R1.cnt END as cnt FROM best_R2, cnt_R1 WHERE cnt_R1.a = best_R2.a)
SELECT a, c, tag FROM best_R1;
CREATE TEMP TABLE node1_R1__R2__R3 AS SELECT node0_best.a as a, R2.b as b, node0_best.c as c FROM R2 JOIN node0_best ON node0_best.c = R2.c SEMI JOIN R1 ON R1.a = node0_best.a AND R1.b = R2.b WHERE node0_best.tag = 0
UNION ALL
SELECT node0_best.a as a, R1.b as b, node0_best.c as c FROM R1 JOIN node0_best ON node0_best.a = R1.a SEMI JOIN R2 ON R2.b = R1.b AND R2.c = node0_best.c WHERE node0_best.tag = 1;
