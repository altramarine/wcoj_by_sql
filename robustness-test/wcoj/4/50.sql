...
CREATE TEMP TABLE node1_R2__R4__R5 AS SELECT node0_best.b as b, R2.c as c, node0_best.d as d FROM R2 JOIN node0_best ON node0_best.b = R2.b SEMI JOIN R5 ON R5.c = R2.c AND R5.d = node0_best.d WHERE node0_best.tag = 0
UNION ALL
SELECT node0_best.b as b, R5.c as c, node0_best.d as d FROM R5 JOIN node0_best ON node0_best.d = R5.d SEMI JOIN R2 ON R2.b = node0_best.b AND R2.c = R5.c WHERE node0_best.tag = 1;
