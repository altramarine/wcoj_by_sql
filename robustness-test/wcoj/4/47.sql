...
CREATE TEMP TABLE node5_best AS WITH
  ...
  best_R1__R4 as (SELECT node5_R2__R5.b as b, node5_R2__R5.c as c, node5_R2__R5.d as d, 0 as tag, cnt_R1__R4.cnt as cnt FROM node5_R2__R5, cnt_R1__R4 WHERE cnt_R1__R4.b = node5_R2__R5.b AND cnt_R1__R4.d = node5_R2__R5.d),
...
UNION ALL
SELECT node7_R1__R2__R3__R4__R5.a as a, node7_R1__R2__R3__R4__R5.b as b, node7_R1__R2__R3__R4__R5.c as c, node7_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_R1__R4.a as a, node4_R1__R4.b as b, node4_best.d as d, node4_best.c as c FROM node4_R1__R4 JOIN node4_best ON node4_best.d = node4_R1__R4.d SEMI JOIN R2 ON R2.b = node4_R1__R4.b AND R2.c = node4_best.c WHERE node4_best.tag = 1) node7_R1__R2__R3__R4__R5
UNION ALL
SELECT node6_R1__R2__R3__R4__R5.a as a, node6_R1__R2__R3__R4__R5.b as b, node6_R1__R2__R3__R4__R5.c as c, node6_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_R1__R4.a as a, node5_best.b as b, node5_best.d as d, node5_best.c as c FROM node4_R1__R4 JOIN node5_best ON node5_best.b = node4_R1__R4.b AND node5_best.d = node4_R1__R4.d SEMI JOIN R3 ON R3.a = node4_R1__R4.a AND R3.c = node5_best.c WHERE node5_best.tag = 0) node6_R1__R2__R3__R4__R5
UNION ALL
SELECT node6_R1__R2__R3__R4__R5.a as a, node6_R1__R2__R3__R4__R5.b as b, node6_R1__R2__R3__R4__R5.c as c, node6_R1__R2__R3__R4__R5.d as d FROM (SELECT R3.a as a, node5_best.b as b, node5_best.d as d, node5_best.c as c FROM R3 JOIN node5_best ON node5_best.c = R3.c WHERE node5_best.tag = 1) node6_R1__R2__R3__R4__R5
);
