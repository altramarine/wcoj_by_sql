...
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R5.c as c FROM R5 JOIN node4_best ON node4_best.d = R5.d SEMI JOIN R3 ON R3.a = node4_best.a AND R3.c = R5.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4__R5
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R3.c as c FROM R3 JOIN node4_best ON node4_best.a = R3.a SEMI JOIN R5 ON R5.c = R3.c AND R5.d = node4_best.d WHERE node4_best.tag = 1) node5_R1__R2__R3__R4__R5
);
