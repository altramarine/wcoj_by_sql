...
CREATE TEMP TABLE node2_best AS WITH
  ...
  best_R1__R4 as (SELECT node1_R3__R5.a as a, node1_R3__R5.c as c, node1_R3__R5.d as d, 0 as tag, cnt_R1__R4.cnt as cnt FROM node1_R3__R5, cnt_R1__R4 WHERE cnt_R1__R4.a = node1_R3__R5.a AND cnt_R1__R4.d = node1_R3__R5.d),
