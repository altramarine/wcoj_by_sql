...
CREATE TEMP TABLE node4_R1__R2__R3 AS SELECT R1.a as a, node0_best.b as b, node0_best.c as c FROM R1 JOIN node0_best ON node0_best.b = R1.b WHERE node0_best.tag = 1;
...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R1__R2__R3 as (SELECT c, COUNT(*) as cnt FROM node4_R1__R2__R3 GROUP BY c),
...
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_R1__R2__R3.a as a, node4_R1__R2__R3.b as b, node4_best.c as c, node4_best.d as d FROM node4_R1__R2__R3 JOIN node4_best ON node4_best.c = node4_R1__R2__R3.c SEMI JOIN R4 ON R4.b = node4_R1__R2__R3.b AND R4.d = node4_best.d WHERE node4_best.tag = 0) node5_R1__R2__R3__R4__R5
UNION ALL
SELECT node4_R1__R2__R3.a as a, node6_R4__R5.b as b, node6_R4__R5.c as c, node6_R4__R5.d as d FROM (SELECT R4.b as b, node4_best.d as d, node4_best.c as c FROM R4 JOIN node4_best ON node4_best.d = R4.d WHERE node4_best.tag = 1) node6_R4__R5 JOIN node4_R1__R2__R3 ON node4_R1__R2__R3.b = node6_R4__R5.b AND node4_R1__R2__R3.c = node6_R4__R5.c
);
