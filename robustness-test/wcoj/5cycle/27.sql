...
CREATE TEMP TABLE node12_R2__R3__R4 AS SELECT node8_best.b as b, node8_best.c as c, node8_R3__R4.d as d, node8_R3__R4.e as e FROM node8_R3__R4 JOIN node8_best ON node8_best.c = node8_R3__R4.c WHERE node8_best.tag = 1;
...
CREATE TEMP TABLE node9_best AS WITH
  cnt_R3__R4 as (SELECT c, COUNT(*) as cnt FROM node8_R3__R4 GROUP BY c),
  best_R3__R4 as (SELECT node9_R1__R2.a as a, node9_R1__R2.b as b, node9_R1__R2.c as c, 0 as tag, cnt_R3__R4.cnt as cnt FROM node9_R1__R2, cnt_R3__R4 WHERE cnt_R3__R4.c = node9_R1__R2.c),
...
CREATE TEMP TABLE node12_best AS WITH
  cnt_R1 as (SELECT b, COUNT(*) as cnt FROM R1 GROUP BY b),
  best_R1 as (SELECT node12_R2__R3__R4.b as b, node12_R2__R3__R4.c as c, node12_R2__R3__R4.d as d, node12_R2__R3__R4.e as e, 0 as tag, cnt_R1.cnt as cnt FROM node12_R2__R3__R4, cnt_R1 WHERE cnt_R1.b = node12_R2__R3__R4.b),
  cnt_R5 as (SELECT e, COUNT(*) as cnt FROM R5 GROUP BY e),
...
UNION ALL
SELECT node10_R1__R2__R3__R4__R5.a as a, node10_R1__R2__R3__R4__R5.b as b, node10_R1__R2__R3__R4__R5.c as c, node10_R1__R2__R3__R4__R5.d as d, node10_R1__R2__R3__R4__R5.e as e FROM (SELECT node9_best.a as a, node9_best.b as b, node9_best.c as c, node8_R3__R4.d as d, node8_R3__R4.e as e FROM node8_R3__R4 JOIN node9_best ON node9_best.c = node8_R3__R4.c SEMI JOIN R5 ON R5.e = node8_R3__R4.e AND R5.a = node9_best.a WHERE node9_best.tag = 0) node10_R1__R2__R3__R4__R5
UNION ALL
SELECT node11_R1__R2__R5.a as a, node11_R1__R2__R5.b as b, node11_R1__R2__R5.c as c, node8_R3__R4.d as d, node11_R1__R2__R5.e as e FROM (SELECT node9_best.a as a, node9_best.b as b, node9_best.c as c, R5.e as e FROM R5 JOIN node9_best ON node9_best.a = R5.a WHERE node9_best.tag = 1) node11_R1__R2__R5 JOIN node8_R3__R4 ON node8_R3__R4.c = node11_R1__R2__R5.c AND node8_R3__R4.e = node11_R1__R2__R5.e
UNION ALL
SELECT node13_R1__R2__R3__R4__R5.a as a, node13_R1__R2__R3__R4__R5.b as b, node13_R1__R2__R3__R4__R5.c as c, node13_R1__R2__R3__R4__R5.d as d, node13_R1__R2__R3__R4__R5.e as e FROM (SELECT R1.a as a, node12_best.b as b, node12_best.c as c, node12_best.d as d, node12_best.e as e FROM R1 JOIN node12_best ON node12_best.b = R1.b SEMI JOIN R5 ON R5.e = node12_best.e AND R5.a = R1.a WHERE node12_best.tag = 0) node13_R1__R2__R3__R4__R5
UNION ALL
SELECT node13_R1__R2__R3__R4__R5.a as a, node13_R1__R2__R3__R4__R5.b as b, node13_R1__R2__R3__R4__R5.c as c, node13_R1__R2__R3__R4__R5.d as d, node13_R1__R2__R3__R4__R5.e as e FROM (SELECT R5.a as a, node12_best.b as b, node12_best.c as c, node12_best.d as d, node12_best.e as e FROM R5 JOIN node12_best ON node12_best.e = R5.e SEMI JOIN R1 ON R1.a = R5.a AND R1.b = node12_best.b WHERE node12_best.tag = 1) node13_R1__R2__R3__R4__R5
);
