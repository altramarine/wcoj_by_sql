...
-- | R5 [R4, R1__R2]
-- | [8] R1__R2(a, b, c), R3(c, d), R4__R5(d, e, a)
-- | | R1__R2 [R3, R4__R5]
-- | | [9] R1__R2__R3(a, b, c, d), R4__R5(d, e, a) [acyclic]
-- | | [10] R1__R2__R3__R4__R5(a, b, c, d, e) [acyclic]
-- | [11] R1__R2__R5(a, b, c, e), R3(c, d), R4(d, e)
-- | | R4 [R3, R1__R2__R5]
-- | | [12] R1__R2__R5(a, b, c, e), R3__R4(c, d, e) [acyclic]
...
CREATE TEMP TABLE node4_R4__R5 AS SELECT node1_best.d as d, node1_best.e as e, R5.a as a FROM R5 JOIN node1_best ON node1_best.e = R5.e WHERE node1_best.tag = 1;
...
CREATE TEMP TABLE node11_R1__R2__R5 AS SELECT node7_best.a as a, node7_R1__R2.b as b, node7_R1__R2.c as c, node7_best.e as e FROM node7_R1__R2 JOIN node7_best ON node7_best.a = node7_R1__R2.a WHERE node7_best.tag = 1;
...
CREATE TEMP TABLE node4_best AS WITH
  ...
  cnt_R4__R5 as (SELECT a, COUNT(*) as cnt FROM node4_R4__R5 GROUP BY a),
...
CREATE TEMP TABLE node8_best AS WITH
  ...
  cnt_R4__R5 as (SELECT a, COUNT(*) as cnt FROM node8_R4__R5 GROUP BY a),
...
UNION ALL
SELECT node5_R1__R2__R3.a as a, node5_R1__R2__R3.b as b, node5_R1__R2__R3.c as c, node5_R1__R2__R3.d as d, node4_R4__R5.e as e FROM (SELECT node4_best.a as a, node4_best.b as b, node1_R2__R3.c as c, node1_R2__R3.d as d FROM node1_R2__R3 JOIN node4_best ON node4_best.b = node1_R2__R3.b WHERE node4_best.tag = 0) node5_R1__R2__R3 JOIN node4_R4__R5 ON node4_R4__R5.d = node5_R1__R2__R3.d AND node4_R4__R5.a = node5_R1__R2__R3.a
UNION ALL
SELECT node6_R1__R4__R5.a as a, node6_R1__R4__R5.b as b, node1_R2__R3.c as c, node6_R1__R4__R5.d as d, node6_R1__R4__R5.e as e FROM (SELECT node4_best.a as a, node4_best.b as b, node4_R4__R5.d as d, node4_R4__R5.e as e FROM node4_R4__R5 JOIN node4_best ON node4_best.a = node4_R4__R5.a WHERE node4_best.tag = 1) node6_R1__R4__R5 JOIN node1_R2__R3 ON node1_R2__R3.b = node6_R1__R4__R5.b AND node1_R2__R3.d = node6_R1__R4__R5.d
UNION ALL
SELECT node9_R1__R2__R3.a as a, node9_R1__R2__R3.b as b, node9_R1__R2__R3.c as c, node9_R1__R2__R3.d as d, node8_R4__R5.e as e FROM (SELECT node8_best.a as a, node8_best.b as b, node8_best.c as c, R3.d as d FROM R3 JOIN node8_best ON node8_best.c = R3.c WHERE node8_best.tag = 0) node9_R1__R2__R3 JOIN node8_R4__R5 ON node8_R4__R5.d = node9_R1__R2__R3.d AND node8_R4__R5.a = node9_R1__R2__R3.a
UNION ALL
SELECT node10_R1__R2__R3__R4__R5.a as a, node10_R1__R2__R3__R4__R5.b as b, node10_R1__R2__R3__R4__R5.c as c, node10_R1__R2__R3__R4__R5.d as d, node10_R1__R2__R3__R4__R5.e as e FROM (SELECT node8_best.a as a, node8_best.b as b, node8_best.c as c, node8_R4__R5.d as d, node8_R4__R5.e as e FROM node8_R4__R5 JOIN node8_best ON node8_best.a = node8_R4__R5.a SEMI JOIN R3 ON R3.c = node8_best.c AND R3.d = node8_R4__R5.d WHERE node8_best.tag = 1) node10_R1__R2__R3__R4__R5
UNION ALL
SELECT node11_R1__R2__R5.a as a, node11_R1__R2__R5.b as b, node12_R3__R4.c as c, node12_R3__R4.d as d, node12_R3__R4.e as e FROM (SELECT R3.c as c, node11_best.d as d, node11_best.e as e FROM R3 JOIN node11_best ON node11_best.d = R3.d WHERE node11_best.tag = 0) node12_R3__R4 JOIN node11_R1__R2__R5 ON node11_R1__R2__R5.c = node12_R3__R4.c AND node11_R1__R2__R5.e = node12_R3__R4.e
UNION ALL
SELECT node13_R1__R2__R3__R4__R5.a as a, node13_R1__R2__R3__R4__R5.b as b, node13_R1__R2__R3__R4__R5.c as c, node13_R1__R2__R3__R4__R5.d as d, node13_R1__R2__R3__R4__R5.e as e FROM (SELECT node11_R1__R2__R5.a as a, node11_R1__R2__R5.b as b, node11_R1__R2__R5.c as c, node11_best.e as e, node11_best.d as d FROM node11_R1__R2__R5 JOIN node11_best ON node11_best.e = node11_R1__R2__R5.e SEMI JOIN R3 ON R3.c = node11_R1__R2__R5.c AND R3.d = node11_best.d WHERE node11_best.tag = 1) node13_R1__R2__R3__R4__R5
);
