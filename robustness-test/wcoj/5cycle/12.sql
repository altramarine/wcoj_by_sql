...
-- | | R1__R5 [R2, R3__R4]
-- | | [13] R1__R2__R5(a, b, e, c), R3__R4(c, d, e) [acyclic]
-- | | [14] R1__R2__R3__R4__R5(a, b, e, c, d) [acyclic]
...
CREATE TEMP TABLE node12_best AS WITH
  cnt_R2 as (SELECT b, COUNT(*) as cnt FROM R2 GROUP BY b),
  best_R2 as (SELECT node12_R1__R5.a as a, node12_R1__R5.b as b, node12_R1__R5.e as e, 0 as tag, cnt_R2.cnt as cnt FROM node12_R1__R5, cnt_R2 WHERE cnt_R2.b = node12_R1__R5.b),
...
UNION ALL
SELECT node13_R1__R2__R5.a as a, node13_R1__R2__R5.b as b, node13_R1__R2__R5.c as c, node8_R3__R4.d as d, node13_R1__R2__R5.e as e FROM (SELECT node12_best.a as a, node12_best.b as b, node12_best.e as e, R2.c as c FROM R2 JOIN node12_best ON node12_best.b = R2.b WHERE node12_best.tag = 0) node13_R1__R2__R5 JOIN node8_R3__R4 ON node8_R3__R4.c = node13_R1__R2__R5.c AND node8_R3__R4.e = node13_R1__R2__R5.e
UNION ALL
SELECT node14_R1__R2__R3__R4__R5.a as a, node14_R1__R2__R3__R4__R5.b as b, node14_R1__R2__R3__R4__R5.c as c, node14_R1__R2__R3__R4__R5.d as d, node14_R1__R2__R3__R4__R5.e as e FROM (SELECT node12_best.a as a, node12_best.b as b, node12_best.e as e, node8_R3__R4.c as c, node8_R3__R4.d as d FROM node8_R3__R4 JOIN node12_best ON node12_best.e = node8_R3__R4.e SEMI JOIN R2 ON R2.b = node12_best.b AND R2.c = node8_R3__R4.c WHERE node12_best.tag = 1) node14_R1__R2__R3__R4__R5
);
