...
CREATE TEMP TABLE node12_R4__R5 AS SELECT R4.d as d, node8_best.e as e, node8_best.a as a FROM R4 JOIN node8_best ON node8_best.e = R4.e WHERE node8_best.tag = 1;
...
CREATE TEMP TABLE node12_best AS WITH
  cnt_R1 as (SELECT a, COUNT(*) as cnt FROM R1 GROUP BY a),
  best_R1 as (SELECT node12_R4__R5.d as d, node12_R4__R5.e as e, node12_R4__R5.a as a, 0 as tag, cnt_R1.cnt as cnt FROM node12_R4__R5, cnt_R1 WHERE cnt_R1.a = node12_R4__R5.a),
  cnt_R2__R3 as (SELECT d, COUNT(*) as cnt FROM node8_R2__R3 GROUP BY d),
  best_R2__R3 as (SELECT best_R1.d as d, best_R1.e as e, best_R1.a as a, CASE WHEN best_R1.cnt < cnt_R2__R3.cnt THEN best_R1.tag ELSE 1 END as tag,CASE WHEN best_R1.cnt < cnt_R2__R3.cnt THEN best_R1.cnt ELSE cnt_R2__R3.cnt END as cnt FROM best_R1, cnt_R2__R3 WHERE cnt_R2__R3.d = best_R1.d)
SELECT d, e, a, tag FROM best_R2__R3;
SELECT COUNT(*) FROM (
...
UNION ALL
SELECT node10_R1__R4__R5.a as a, node10_R1__R4__R5.b as b, node8_R2__R3.c as c, node10_R1__R4__R5.d as d, node10_R1__R4__R5.e as e FROM (SELECT node9_R1__R5.a as a, node9_R1__R5.b as b, node9_best.e as e, node9_best.d as d FROM node9_R1__R5 JOIN node9_best ON node9_best.e = node9_R1__R5.e WHERE node9_best.tag = 0) node10_R1__R4__R5 JOIN node8_R2__R3 ON node8_R2__R3.b = node10_R1__R4__R5.b AND node8_R2__R3.d = node10_R1__R4__R5.d
UNION ALL
SELECT node9_R1__R5.a as a, node11_R2__R3__R4.b as b, node11_R2__R3__R4.c as c, node11_R2__R3__R4.d as d, node11_R2__R3__R4.e as e FROM (SELECT node8_R2__R3.b as b, node8_R2__R3.c as c, node9_best.d as d, node9_best.e as e FROM node8_R2__R3 JOIN node9_best ON node9_best.d = node8_R2__R3.d WHERE node9_best.tag = 1) node11_R2__R3__R4 JOIN node9_R1__R5 ON node9_R1__R5.b = node11_R2__R3__R4.b AND node9_R1__R5.e = node11_R2__R3__R4.e
UNION ALL
SELECT node13_R1__R4__R5.a as a, node13_R1__R4__R5.b as b, node8_R2__R3.c as c, node13_R1__R4__R5.d as d, node13_R1__R4__R5.e as e FROM (SELECT node12_best.a as a, R1.b as b, node12_best.d as d, node12_best.e as e FROM R1 JOIN node12_best ON node12_best.a = R1.a WHERE node12_best.tag = 0) node13_R1__R4__R5 JOIN node8_R2__R3 ON node8_R2__R3.b = node13_R1__R4__R5.b AND node8_R2__R3.d = node13_R1__R4__R5.d
UNION ALL
SELECT node14_R1__R2__R3__R4__R5.a as a, node14_R1__R2__R3__R4__R5.b as b, node14_R1__R2__R3__R4__R5.c as c, node14_R1__R2__R3__R4__R5.d as d, node14_R1__R2__R3__R4__R5.e as e FROM (SELECT node12_best.a as a, node8_R2__R3.b as b, node8_R2__R3.c as c, node12_best.d as d, node12_best.e as e FROM node8_R2__R3 JOIN node12_best ON node12_best.d = node8_R2__R3.d SEMI JOIN R1 ON R1.a = node12_best.a AND R1.b = node8_R2__R3.b WHERE node12_best.tag = 1) node14_R1__R2__R3__R4__R5
);
