...
CREATE TEMP TABLE node8_best AS WITH
  ...
  best_R4__R5 as (SELECT best_R2.a as a, best_R2.b as b, CASE WHEN best_R2.cnt < cnt_R4__R5.cnt THEN best_R2.tag ELSE 1 END as tag,CASE WHEN best_R2.cnt < cnt_R4__R5.cnt THEN best_R2.cnt ELSE cnt_R4__R5.cnt END as cnt FROM best_R2, cnt_R4__R5 WHERE cnt_R4__R5.a = best_R2.a)
...
CREATE TEMP TABLE node12_R1__R4__R5 AS SELECT node8_best.a as a, node8_best.b as b, node8_R4__R5.d as d, node8_R4__R5.e as e FROM node8_R4__R5 JOIN node8_best ON node8_best.a = node8_R4__R5.a WHERE node8_best.tag = 1;
...
CREATE TEMP TABLE node9_best AS WITH
  cnt_R4__R5 as (SELECT a, COUNT(*) as cnt FROM node8_R4__R5 GROUP BY a),
  best_R4__R5 as (SELECT node9_R1__R2.a as a, node9_R1__R2.b as b, node9_R1__R2.c as c, 0 as tag, cnt_R4__R5.cnt as cnt FROM node9_R1__R2, cnt_R4__R5 WHERE cnt_R4__R5.a = node9_R1__R2.a),
...
UNION ALL
SELECT node10_R1__R2__R3__R4__R5.a as a, node10_R1__R2__R3__R4__R5.b as b, node10_R1__R2__R3__R4__R5.c as c, node10_R1__R2__R3__R4__R5.d as d, node10_R1__R2__R3__R4__R5.e as e FROM (SELECT node9_best.a as a, node9_best.b as b, node9_best.c as c, node8_R4__R5.d as d, node8_R4__R5.e as e FROM node8_R4__R5 JOIN node9_best ON node9_best.a = node8_R4__R5.a SEMI JOIN R3 ON R3.c = node9_best.c AND R3.d = node8_R4__R5.d WHERE node9_best.tag = 0) node10_R1__R2__R3__R4__R5
UNION ALL
SELECT node11_R1__R2__R3.a as a, node11_R1__R2__R3.b as b, node11_R1__R2__R3.c as c, node11_R1__R2__R3.d as d, node8_R4__R5.e as e FROM (SELECT node9_best.a as a, node9_best.b as b, node9_best.c as c, R3.d as d FROM R3 JOIN node9_best ON node9_best.c = R3.c WHERE node9_best.tag = 1) node11_R1__R2__R3 JOIN node8_R4__R5 ON node8_R4__R5.d = node11_R1__R2__R3.d AND node8_R4__R5.a = node11_R1__R2__R3.a
UNION ALL
SELECT node13_R1__R2__R3__R4__R5.a as a, node13_R1__R2__R3__R4__R5.b as b, node13_R1__R2__R3__R4__R5.c as c, node13_R1__R2__R3__R4__R5.d as d, node13_R1__R2__R3__R4__R5.e as e FROM (SELECT node12_R1__R4__R5.a as a, node12_R1__R4__R5.b as b, node12_best.d as d, node12_R1__R4__R5.e as e, node12_best.c as c FROM node12_R1__R4__R5 JOIN node12_best ON node12_best.d = node12_R1__R4__R5.d SEMI JOIN R2 ON R2.b = node12_R1__R4__R5.b AND R2.c = node12_best.c WHERE node12_best.tag = 0) node13_R1__R2__R3__R4__R5
UNION ALL
SELECT node12_R1__R4__R5.a as a, node14_R2__R3.b as b, node14_R2__R3.c as c, node14_R2__R3.d as d, node12_R1__R4__R5.e as e FROM (SELECT R2.b as b, node12_best.c as c, node12_best.d as d FROM R2 JOIN node12_best ON node12_best.c = R2.c WHERE node12_best.tag = 1) node14_R2__R3 JOIN node12_R1__R4__R5 ON node12_R1__R4__R5.b = node14_R2__R3.b AND node12_R1__R4__R5.d = node14_R2__R3.d
);
