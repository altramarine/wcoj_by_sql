...
CREATE TEMP TABLE node8_best AS WITH
  ...
  best_R2__R3 as (SELECT best_R5.a as a, best_R5.b as b, CASE WHEN best_R5.cnt < cnt_R2__R3.cnt THEN best_R5.tag ELSE 1 END as tag,CASE WHEN best_R5.cnt < cnt_R2__R3.cnt THEN best_R5.cnt ELSE cnt_R2__R3.cnt END as cnt FROM best_R5, cnt_R2__R3 WHERE cnt_R2__R3.b = best_R5.b)
...
CREATE TEMP TABLE node12_R1__R2__R3 AS SELECT node8_best.a as a, node8_best.b as b, node8_R2__R3.c as c, node8_R2__R3.d as d FROM node8_R2__R3 JOIN node8_best ON node8_best.b = node8_R2__R3.b WHERE node8_best.tag = 1;
