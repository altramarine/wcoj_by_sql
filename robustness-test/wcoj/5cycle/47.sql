...
-- | [12] R1__R5(a, b, e), R2(b, c), R3__R4(c, d, e)
-- | | R2 [R3__R4, R1__R5]
...
CREATE TEMP TABLE node9_R1__R2 AS SELECT node8_best.a as a, node8_best.b as b, R2.c as c FROM R2 JOIN node8_best ON node8_best.b = R2.b WHERE node8_best.tag = 0;
CREATE TEMP TABLE node12_R1__R5 AS SELECT node8_best.a as a, node8_best.b as b, R5.e as e FROM R5 JOIN node8_best ON node8_best.a = R5.a WHERE node8_best.tag = 1;
...
CREATE TEMP TABLE node12_best AS WITH
  ...
  cnt_R1__R5 as (SELECT b, COUNT(*) as cnt FROM node12_R1__R5 GROUP BY b),
...
UNION ALL
SELECT node6_R1__R4__R5.a as a, node6_R1__R4__R5.b as b, node1_R2__R3.c as c, node6_R1__R4__R5.d as d, node6_R1__R4__R5.e as e FROM (SELECT node5_R1__R5.a as a, node5_R1__R5.b as b, node5_best.e as e, node5_best.d as d FROM node5_R1__R5 JOIN node5_best ON node5_best.e = node5_R1__R5.e WHERE node5_best.tag = 0) node6_R1__R4__R5 JOIN node1_R2__R3 ON node1_R2__R3.b = node6_R1__R4__R5.b AND node1_R2__R3.d = node6_R1__R4__R5.d
UNION ALL
SELECT node5_R1__R5.a as a, node7_R2__R3__R4.b as b, node7_R2__R3__R4.c as c, node7_R2__R3__R4.d as d, node7_R2__R3__R4.e as e FROM (SELECT node1_R2__R3.b as b, node1_R2__R3.c as c, node5_best.d as d, node5_best.e as e FROM node1_R2__R3 JOIN node5_best ON node5_best.d = node1_R2__R3.d WHERE node5_best.tag = 1) node7_R2__R3__R4 JOIN node5_R1__R5 ON node5_R1__R5.b = node7_R2__R3__R4.b AND node5_R1__R5.e = node7_R2__R3__R4.e
UNION ALL
SELECT node10_R3__R4__R5.a as a, node9_R1__R2.b as b, node10_R3__R4__R5.c as c, node10_R3__R4__R5.d as d, node10_R3__R4__R5.e as e FROM (SELECT node9_best.c as c, node9_best.d as d, node9_best.e as e, R5.a as a FROM R5 JOIN node9_best ON node9_best.e = R5.e WHERE node9_best.tag = 0) node10_R3__R4__R5 JOIN node9_R1__R2 ON node9_R1__R2.a = node10_R3__R4__R5.a AND node9_R1__R2.c = node10_R3__R4__R5.c
UNION ALL
SELECT node11_R1__R2__R3__R4__R5.a as a, node11_R1__R2__R3__R4__R5.b as b, node11_R1__R2__R3__R4__R5.c as c, node11_R1__R2__R3__R4__R5.d as d, node11_R1__R2__R3__R4__R5.e as e FROM (SELECT node9_R1__R2.a as a, node9_R1__R2.b as b, node9_best.c as c, node9_best.d as d, node9_best.e as e FROM node9_R1__R2 JOIN node9_best ON node9_best.c = node9_R1__R2.c SEMI JOIN R5 ON R5.e = node9_best.e AND R5.a = node9_R1__R2.a WHERE node9_best.tag = 1) node11_R1__R2__R3__R4__R5
UNION ALL
SELECT node12_R1__R5.a as a, node13_R2__R3__R4.b as b, node13_R2__R3__R4.c as c, node13_R2__R3__R4.d as d, node13_R2__R3__R4.e as e FROM (SELECT node12_best.b as b, node12_best.c as c, node8_R3__R4.d as d, node8_R3__R4.e as e FROM node8_R3__R4 JOIN node12_best ON node12_best.c = node8_R3__R4.c WHERE node12_best.tag = 0) node13_R2__R3__R4 JOIN node12_R1__R5 ON node12_R1__R5.b = node13_R2__R3__R4.b AND node12_R1__R5.e = node13_R2__R3__R4.e
UNION ALL
SELECT node14_R1__R2__R5.a as a, node14_R1__R2__R5.b as b, node14_R1__R2__R5.c as c, node8_R3__R4.d as d, node14_R1__R2__R5.e as e FROM (SELECT node12_R1__R5.a as a, node12_best.b as b, node12_R1__R5.e as e, node12_best.c as c FROM node12_R1__R5 JOIN node12_best ON node12_best.b = node12_R1__R5.b WHERE node12_best.tag = 1) node14_R1__R2__R5 JOIN node8_R3__R4 ON node8_R3__R4.c = node14_R1__R2__R5.c AND node8_R3__R4.e = node14_R1__R2__R5.e
);
