...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R2 as (SELECT a, COUNT(*) as cnt FROM R2 GROUP BY a),
  best_R2 as (SELECT node4_R3__R4.a as a, node4_R3__R4.b as b, node4_R3__R4.c as c, 0 as tag, cnt_R2.cnt as cnt FROM node4_R3__R4, cnt_R2 WHERE cnt_R2.a = node4_R3__R4.a),
  cnt_R1 as (SELECT c, COUNT(*) as cnt FROM R1 GROUP BY c),
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, R2.d as d, node4_best.a as a, node4_best.b as b FROM R2 JOIN node4_best ON node4_best.a = R2.a SEMI JOIN R1 ON R1.c = node4_best.c AND R1.d = R2.d WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, R1.d as d, node4_best.a as a, node4_best.b as b FROM R1 JOIN node4_best ON node4_best.c = R1.c SEMI JOIN R2 ON R2.a = node4_best.a AND R2.d = R1.d WHERE node4_best.tag = 1) node5_R1__R2__R3__R4
);
