...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, node4_R2__R3.a as a, node4_R2__R3.b as b FROM node4_R2__R3 JOIN node4_best ON node4_best.d = node4_R2__R3.d SEMI JOIN R4 ON R4.b = node4_R2__R3.b AND R4.c = node4_best.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node4_R2__R3.a as a, node6_R1__R4.b as b, node6_R1__R4.c as c, node6_R1__R4.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, R4.b as b FROM R4 JOIN node4_best ON node4_best.c = R4.c WHERE node4_best.tag = 1) node6_R1__R4 JOIN node4_R2__R3 ON node4_R2__R3.d = node6_R1__R4.d AND node4_R2__R3.b = node6_R1__R4.b
);
