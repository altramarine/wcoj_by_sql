...
CREATE TEMP TABLE node3_R1__R4 AS SELECT node0_best.c as c, node0_best.d as d, R4.b as b FROM R4 JOIN node0_best ON node0_best.c = R4.c WHERE node0_best.tag = 1;
