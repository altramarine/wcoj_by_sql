...
SELECT COUNT(*) FROM (
SELECT node1_R2__R3.a as a, node2_R1__R4.b as b, node2_R1__R4.c as c, node2_R1__R4.d as d FROM (SELECT node1_best.c as c, R1.d as d, node1_best.b as b FROM R1 JOIN node1_best ON node1_best.c = R1.c WHERE node1_best.tag = 0) node2_R1__R4 JOIN node1_R2__R3 ON node1_R2__R3.d = node2_R1__R4.d AND node1_R2__R3.b = node2_R1__R4.b
UNION ALL
SELECT node3_R1__R2__R3__R4.a as a, node3_R1__R2__R3__R4.b as b, node3_R1__R2__R3__R4.c as c, node3_R1__R2__R3__R4.d as d FROM (SELECT node1_best.c as c, node1_R2__R3.d as d, node1_R2__R3.a as a, node1_best.b as b FROM node1_R2__R3 JOIN node1_best ON node1_best.b = node1_R2__R3.b SEMI JOIN R1 ON R1.c = node1_best.c AND R1.d = node1_R2__R3.d WHERE node1_best.tag = 1) node3_R1__R2__R3__R4
UNION ALL
