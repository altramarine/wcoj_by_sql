...
UNION ALL
SELECT node3_R2__R3.a as a, node4_R1__R4.b as b, node4_R1__R4.c as c, node4_R1__R4.d as d FROM (SELECT node3_best.c as c, R1.d as d, node3_best.b as b FROM R1 JOIN node3_best ON node3_best.c = R1.c WHERE node3_best.tag = 0) node4_R1__R4 JOIN node3_R2__R3 ON node3_R2__R3.d = node4_R1__R4.d AND node3_R2__R3.b = node4_R1__R4.b
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node3_best.c as c, node3_R2__R3.d as d, node3_R2__R3.a as a, node3_best.b as b FROM node3_R2__R3 JOIN node3_best ON node3_best.b = node3_R2__R3.b SEMI JOIN R1 ON R1.c = node3_best.c AND R1.d = node3_R2__R3.d WHERE node3_best.tag = 1) node5_R1__R2__R3__R4
);
