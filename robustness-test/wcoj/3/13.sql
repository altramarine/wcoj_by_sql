...
CREATE TEMP TABLE node1_best AS WITH
  ...
  best_R2 as (SELECT node1_R1__R4.c as c, node1_R1__R4.d as d, node1_R1__R4.b as b, 0 as tag, cnt_R2.cnt as cnt FROM node1_R1__R4, cnt_R2 WHERE cnt_R2.d = node1_R1__R4.d),
  cnt_R3 as (SELECT b, COUNT(*) as cnt FROM R3 GROUP BY b),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.c as c, node1_best.d as d, node1_best.b as b, R2.a as a FROM R2 JOIN node1_best ON node1_best.d = R2.d SEMI JOIN R3 ON R3.a = R2.a AND R3.b = node1_best.b WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.c as c, node1_best.d as d, node1_best.b as b, R3.a as a FROM R3 JOIN node1_best ON node1_best.b = R3.b SEMI JOIN R2 ON R2.a = R3.a AND R2.d = node1_best.d WHERE node1_best.tag = 1) node2_R1__R2__R3__R4
UNION ALL
