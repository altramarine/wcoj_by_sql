...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R2 as (SELECT d, COUNT(*) as cnt FROM R2 GROUP BY d),
  best_R2 as (SELECT node4_R1__R4.c as c, node4_R1__R4.d as d, node4_R1__R4.b as b, 0 as tag, cnt_R2.cnt as cnt FROM node4_R1__R4, cnt_R2 WHERE cnt_R2.d = node4_R1__R4.d),
  cnt_R3 as (SELECT b, COUNT(*) as cnt FROM R3 GROUP BY b),
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, node4_best.b as b, R2.a as a FROM R2 JOIN node4_best ON node4_best.d = R2.d SEMI JOIN R3 ON R3.a = R2.a AND R3.b = node4_best.b WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, node4_best.b as b, R3.a as a FROM R3 JOIN node4_best ON node4_best.b = R3.b SEMI JOIN R2 ON R2.a = R3.a AND R2.d = node4_best.d WHERE node4_best.tag = 1) node5_R1__R2__R3__R4
);
