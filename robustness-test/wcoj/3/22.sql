...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, node4_R3__R4.a as a, node4_R3__R4.b as b FROM node4_R3__R4 JOIN node4_best ON node4_best.c = node4_R3__R4.c SEMI JOIN R2 ON R2.a = node4_R3__R4.a AND R2.d = node4_best.d WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node6_R1__R2.a as a, node4_R3__R4.b as b, node6_R1__R2.c as c, node6_R1__R2.d as d FROM (SELECT node4_best.c as c, node4_best.d as d, R2.a as a FROM R2 JOIN node4_best ON node4_best.d = R2.d WHERE node4_best.tag = 1) node6_R1__R2 JOIN node4_R3__R4 ON node4_R3__R4.a = node6_R1__R2.a AND node4_R3__R4.c = node6_R1__R2.c
);
