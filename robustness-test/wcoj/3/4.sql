...
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT node3_R1__R4.c as c, node3_R1__R4.d as d, node3_best.b as b, node3_best.a as a FROM node3_R1__R4 JOIN node3_best ON node3_best.b = node3_R1__R4.b SEMI JOIN R2 ON R2.a = node3_best.a AND R2.d = node3_R1__R4.d WHERE node3_best.tag = 0) node4_R1__R2__R3__R4
UNION ALL
SELECT node5_R2__R3.a as a, node5_R2__R3.b as b, node3_R1__R4.c as c, node5_R2__R3.d as d FROM (SELECT node3_best.a as a, R2.d as d, node3_best.b as b FROM R2 JOIN node3_best ON node3_best.a = R2.a WHERE node3_best.tag = 1) node5_R2__R3 JOIN node3_R1__R4 ON node3_R1__R4.d = node5_R2__R3.d AND node3_R1__R4.b = node5_R2__R3.b
);
