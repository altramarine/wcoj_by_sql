...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.c as c, node1_R1__R2.d as d, node1_R1__R2.a as a, node1_best.b as b FROM node1_R1__R2 JOIN node1_best ON node1_best.c = node1_R1__R2.c SEMI JOIN R3 ON R3.a = node1_R1__R2.a AND R3.b = node1_best.b WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node3_R3__R4.a as a, node3_R3__R4.b as b, node3_R3__R4.c as c, node1_R1__R2.d as d FROM (SELECT R3.a as a, node1_best.b as b, node1_best.c as c FROM R3 JOIN node1_best ON node1_best.b = R3.b WHERE node1_best.tag = 1) node3_R3__R4 JOIN node1_R1__R2 ON node1_R1__R2.c = node3_R3__R4.c AND node1_R1__R2.a = node3_R3__R4.a
UNION ALL
