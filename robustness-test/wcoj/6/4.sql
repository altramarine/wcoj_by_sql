...
CREATE TEMP TABLE node5_R1__R2__R3 AS SELECT R1.a as a, node0_best.b as b, node0_best.c as c FROM R1 JOIN node0_best ON node0_best.b = R1.b WHERE node0_best.tag = 1;
...
CREATE TEMP TABLE node3_R1__R4 AS SELECT node1_best.a as a, R1.b as b, node1_best.d as d FROM R1 JOIN node1_best ON node1_best.a = R1.a WHERE node1_best.tag = 1;
...
CREATE TEMP TABLE node6_R5__R6 AS SELECT R5.b as b, node5_best.d as d, node5_best.c as c FROM R5 JOIN node5_best ON node5_best.d = R5.d WHERE node5_best.tag = 0;
CREATE TEMP TABLE node8_R4__R6 AS SELECT R4.a as a, node5_best.d as d, node5_best.c as c FROM R4 JOIN node5_best ON node5_best.d = R4.d WHERE node5_best.tag = 1;
CREATE TEMP TABLE node3_best AS WITH
  cnt_R2__R5__R6 as (SELECT b,d, COUNT(*) as cnt FROM node1_R2__R5__R6 GROUP BY b,d),
  best_R2__R5__R6 as (SELECT node3_R1__R4.a as a, node3_R1__R4.b as b, node3_R1__R4.d as d, 0 as tag, cnt_R2__R5__R6.cnt as cnt FROM node3_R1__R4, cnt_R2__R5__R6 WHERE cnt_R2__R5__R6.b = node3_R1__R4.b AND cnt_R2__R5__R6.d = node3_R1__R4.d),
  cnt_R3 as (SELECT a, COUNT(*) as cnt FROM R3 GROUP BY a),
  best_R3 as (SELECT best_R2__R5__R6.a as a, best_R2__R5__R6.b as b, best_R2__R5__R6.d as d, CASE WHEN best_R2__R5__R6.cnt < cnt_R3.cnt THEN best_R2__R5__R6.tag ELSE 1 END as tag,CASE WHEN best_R2__R5__R6.cnt < cnt_R3.cnt THEN best_R2__R5__R6.cnt ELSE cnt_R3.cnt END as cnt FROM best_R2__R5__R6, cnt_R3 WHERE cnt_R3.a = best_R2__R5__R6.a)
SELECT a, b, d, tag FROM best_R3;
CREATE TEMP TABLE node6_best AS WITH
  cnt_R4 as (SELECT a, COUNT(*) as cnt FROM R4 GROUP BY a),
  best_R4 as (SELECT node5_R1__R2__R3.a as a, node5_R1__R2__R3.b as b, node5_R1__R2__R3.c as c, 0 as tag, cnt_R4.cnt as cnt FROM node5_R1__R2__R3, cnt_R4 WHERE cnt_R4.a = node5_R1__R2__R3.a),
  cnt_R5__R6 as (SELECT b,c, COUNT(*) as cnt FROM node6_R5__R6 GROUP BY b,c),
  best_R5__R6 as (SELECT best_R4.a as a, best_R4.b as b, best_R4.c as c, CASE WHEN best_R4.cnt < cnt_R5__R6.cnt THEN best_R4.tag ELSE 1 END as tag,CASE WHEN best_R4.cnt < cnt_R5__R6.cnt THEN best_R4.cnt ELSE cnt_R5__R6.cnt END as cnt FROM best_R4, cnt_R5__R6 WHERE cnt_R5__R6.b = best_R4.b AND cnt_R5__R6.c = best_R4.c)
SELECT a, b, c, tag FROM best_R5__R6;
CREATE TEMP TABLE node8_best AS WITH
  cnt_R1__R2__R3 as (SELECT a,c, COUNT(*) as cnt FROM node5_R1__R2__R3 GROUP BY a,c),
  best_R1__R2__R3 as (SELECT node8_R4__R6.a as a, node8_R4__R6.d as d, node8_R4__R6.c as c, 0 as tag, cnt_R1__R2__R3.cnt as cnt FROM node8_R4__R6, cnt_R1__R2__R3 WHERE cnt_R1__R2__R3.a = node8_R4__R6.a AND cnt_R1__R2__R3.c = node8_R4__R6.c),
  cnt_R5 as (SELECT d, COUNT(*) as cnt FROM R5 GROUP BY d),
  best_R5 as (SELECT best_R1__R2__R3.a as a, best_R1__R2__R3.d as d, best_R1__R2__R3.c as c, CASE WHEN best_R1__R2__R3.cnt < cnt_R5.cnt THEN best_R1__R2__R3.tag ELSE 1 END as tag,CASE WHEN best_R1__R2__R3.cnt < cnt_R5.cnt THEN best_R1__R2__R3.cnt ELSE cnt_R5.cnt END as cnt FROM best_R1__R2__R3, cnt_R5 WHERE cnt_R5.d = best_R1__R2__R3.d)
SELECT a, d, c, tag FROM best_R5;
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4__R5__R6.a as a, node2_R1__R2__R3__R4__R5__R6.b as b, node2_R1__R2__R3__R4__R5__R6.c as c, node2_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node1_best.a as a, node1_R2__R5__R6.b as b, node1_R2__R5__R6.c as c, node1_best.d as d FROM node1_R2__R5__R6 JOIN node1_best ON node1_best.d = node1_R2__R5__R6.d SEMI JOIN R1 ON R1.a = node1_best.a AND R1.b = node1_R2__R5__R6.b WHERE node1_best.tag = 0) node2_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node4_R1__R2__R3__R4__R5__R6.a as a, node4_R1__R2__R3__R4__R5__R6.b as b, node4_R1__R2__R3__R4__R5__R6.c as c, node4_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_best.a as a, node3_best.b as b, node3_best.d as d, node1_R2__R5__R6.c as c FROM node1_R2__R5__R6 JOIN node3_best ON node3_best.b = node1_R2__R5__R6.b AND node3_best.d = node1_R2__R5__R6.d SEMI JOIN R3 ON R3.a = node3_best.a AND R3.c = node1_R2__R5__R6.c WHERE node3_best.tag = 0) node4_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node4_R1__R2__R3__R4__R5__R6.a as a, node4_R1__R2__R3__R4__R5__R6.b as b, node4_R1__R2__R3__R4__R5__R6.c as c, node4_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_best.a as a, node3_best.b as b, node3_best.d as d, R3.c as c FROM R3 JOIN node3_best ON node3_best.a = R3.a WHERE node3_best.tag = 1) node4_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node6_best.a as a, node6_best.b as b, node6_best.c as c, R4.d as d FROM R4 JOIN node6_best ON node6_best.a = R4.a SEMI JOIN node6_R5__R6 ON node6_R5__R6.b = node6_best.b AND node6_R5__R6.d = R4.d AND node6_R5__R6.c = node6_best.c WHERE node6_best.tag = 0) node7_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node6_best.a as a, node6_best.b as b, node6_best.c as c, node6_R5__R6.d as d FROM node6_R5__R6 JOIN node6_best ON node6_best.b = node6_R5__R6.b AND node6_best.c = node6_R5__R6.c SEMI JOIN R4 ON R4.a = node6_best.a AND R4.d = node6_R5__R6.d WHERE node6_best.tag = 1) node7_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node9_R1__R2__R3__R4__R5__R6.a as a, node9_R1__R2__R3__R4__R5__R6.b as b, node9_R1__R2__R3__R4__R5__R6.c as c, node9_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node8_best.a as a, node5_R1__R2__R3.b as b, node8_best.c as c, node8_best.d as d FROM node5_R1__R2__R3 JOIN node8_best ON node8_best.a = node5_R1__R2__R3.a AND node8_best.c = node5_R1__R2__R3.c SEMI JOIN R5 ON R5.b = node5_R1__R2__R3.b AND R5.d = node8_best.d WHERE node8_best.tag = 0) node9_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node9_R1__R2__R3__R4__R5__R6.a as a, node9_R1__R2__R3__R4__R5__R6.b as b, node9_R1__R2__R3__R4__R5__R6.c as c, node9_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node8_best.a as a, R5.b as b, node8_best.c as c, node8_best.d as d FROM R5 JOIN node8_best ON node8_best.d = R5.d SEMI JOIN node5_R1__R2__R3 ON node5_R1__R2__R3.a = node8_best.a AND node5_R1__R2__R3.b = R5.b AND node5_R1__R2__R3.c = node8_best.c WHERE node8_best.tag = 1) node9_R1__R2__R3__R4__R5__R6
);
