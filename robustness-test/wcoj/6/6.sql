...
-- | R3 [R1, R2__R5__R6]
-- | [6] R1__R3(a, b, c), R2__R5__R6(b, c, d), R4(a, d)
...
CREATE TEMP TABLE node3_R3__R6 AS SELECT node1_best.a as a, node1_best.c as c, R6.d as d FROM R6 JOIN node1_best ON node1_best.c = R6.c WHERE node1_best.tag = 1;
CREATE TEMP TABLE node5_best AS WITH
  ...
  cnt_R2__R5__R6 as (SELECT c, COUNT(*) as cnt FROM node5_R2__R5__R6 GROUP BY c),
...
CREATE TEMP TABLE node6_R1__R3 AS SELECT node5_best.a as a, R1.b as b, node5_best.c as c FROM R1 JOIN node5_best ON node5_best.a = R1.a WHERE node5_best.tag = 0;
...
CREATE TEMP TABLE node6_best AS WITH
  cnt_R1__R3 as (SELECT b,c, COUNT(*) as cnt FROM node6_R1__R3 GROUP BY b,c),
...
UNION ALL
SELECT node8_R1__R2__R3__R4__R5__R6.a as a, node8_R1__R2__R3__R4__R5__R6.b as b, node8_R1__R2__R3__R4__R5__R6.c as c, node8_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node5_best.a as a, node5_R2__R5__R6.b as b, node5_best.c as c, node5_R2__R5__R6.d as d FROM node5_R2__R5__R6 JOIN node5_best ON node5_best.c = node5_R2__R5__R6.c SEMI JOIN R1 ON R1.a = node5_best.a AND R1.b = node5_R2__R5__R6.b WHERE node5_best.tag = 1) node8_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node4_R1__R2__R3__R4__R5__R6.a as a, node4_R1__R2__R3__R4__R5__R6.b as b, node4_R1__R2__R3__R4__R5__R6.c as c, node4_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_best.a as a, node3_best.b as b, node3_best.d as d, node3_R3__R6.c as c FROM node3_R3__R6 JOIN node3_best ON node3_best.a = node3_R3__R6.a AND node3_best.d = node3_R3__R6.d SEMI JOIN R2 ON R2.b = node3_best.b AND R2.c = node3_R3__R6.c WHERE node3_best.tag = 0) node4_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node4_R1__R2__R3__R4__R5__R6.a as a, node4_R1__R2__R3__R4__R5__R6.b as b, node4_R1__R2__R3__R4__R5__R6.c as c, node4_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_best.a as a, node3_best.b as b, node3_best.d as d, R2.c as c FROM R2 JOIN node3_best ON node3_best.b = R2.b WHERE node3_best.tag = 1) node4_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node6_R1__R3.a as a, node6_best.b as b, node6_best.c as c, node6_best.d as d FROM node6_R1__R3 JOIN node6_best ON node6_best.b = node6_R1__R3.b AND node6_best.c = node6_R1__R3.c SEMI JOIN R4 ON R4.a = node6_R1__R3.a AND R4.d = node6_best.d WHERE node6_best.tag = 0) node7_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT R4.a as a, node6_best.b as b, node6_best.c as c, node6_best.d as d FROM R4 JOIN node6_best ON node6_best.d = R4.d WHERE node6_best.tag = 1) node7_R1__R2__R3__R4__R5__R6
);
