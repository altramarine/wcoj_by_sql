...
-- | [5] R1__R2__R3(a, b, c), R4__R6(a, d, c), R5(b, d)
...
CREATE TEMP TABLE node1_best AS WITH
  cnt_R2 as (SELECT c, COUNT(*) as cnt FROM R2 GROUP BY c),
  best_R2 as (SELECT node1_R3__R4__R6.a as a, node1_R3__R4__R6.c as c, node1_R3__R4__R6.d as d, 0 as tag, cnt_R2.cnt as cnt FROM node1_R3__R4__R6, cnt_R2 WHERE cnt_R2.c = node1_R3__R4__R6.c),
  cnt_R1 as (SELECT a, COUNT(*) as cnt FROM R1 GROUP BY a),
  best_R1 as (SELECT best_R2.a as a, best_R2.c as c, best_R2.d as d, CASE WHEN best_R2.cnt < cnt_R1.cnt THEN best_R2.tag ELSE 1 END as tag,CASE WHEN best_R2.cnt < cnt_R1.cnt THEN best_R2.cnt ELSE cnt_R1.cnt END as cnt FROM best_R2, cnt_R1 WHERE cnt_R1.a = best_R2.a)
SELECT a, c, d, tag FROM best_R1;
CREATE TEMP TABLE node3_best AS WITH
  cnt_R1__R2__R3 as (SELECT c, COUNT(*) as cnt FROM node3_R1__R2__R3 GROUP BY c),
  best_R1__R2__R3 as (SELECT R6.c as c, R6.d as d, 0 as tag, cnt_R1__R2__R3.cnt as cnt FROM R6, cnt_R1__R2__R3 WHERE cnt_R1__R2__R3.c = R6.c),
...
CREATE TEMP TABLE node5_R4__R6 AS SELECT R4.a as a, node3_best.d as d, node3_best.c as c FROM R4 JOIN node3_best ON node3_best.d = R4.d WHERE node3_best.tag = 1;
CREATE TEMP TABLE node5_best AS WITH
  cnt_R4__R6 as (SELECT d, COUNT(*) as cnt FROM node5_R4__R6 GROUP BY d),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4__R5__R6.a as a, node2_R1__R2__R3__R4__R5__R6.b as b, node2_R1__R2__R3__R4__R5__R6.c as c, node2_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node1_best.a as a, R2.b as b, node1_best.c as c, node1_best.d as d FROM R2 JOIN node1_best ON node1_best.c = R2.c SEMI JOIN R1 ON R1.a = node1_best.a AND R1.b = R2.b WHERE node1_best.tag = 0) node2_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node2_R1__R2__R3__R4__R5__R6.a as a, node2_R1__R2__R3__R4__R5__R6.b as b, node2_R1__R2__R3__R4__R5__R6.c as c, node2_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node1_best.a as a, R1.b as b, node1_best.c as c, node1_best.d as d FROM R1 JOIN node1_best ON node1_best.a = R1.a SEMI JOIN R2 ON R2.b = R1.b AND R2.c = node1_best.c WHERE node1_best.tag = 1) node2_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node4_R1__R2__R3__R4__R5__R6.a as a, node4_R1__R2__R3__R4__R5__R6.b as b, node4_R1__R2__R3__R4__R5__R6.c as c, node4_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_R1__R2__R3.a as a, node3_R1__R2__R3.b as b, node3_best.c as c, node3_best.d as d FROM node3_R1__R2__R3 JOIN node3_best ON node3_best.c = node3_R1__R2__R3.c SEMI JOIN R4 ON R4.a = node3_R1__R2__R3.a AND R4.d = node3_best.d WHERE node3_best.tag = 0) node4_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node6_R1__R2__R3__R4__R5__R6.a as a, node6_R1__R2__R3__R4__R5__R6.b as b, node6_R1__R2__R3__R4__R5__R6.c as c, node6_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node5_R4__R6.a as a, node5_best.b as b, node5_R4__R6.c as c, node5_best.d as d FROM node5_R4__R6 JOIN node5_best ON node5_best.d = node5_R4__R6.d SEMI JOIN node3_R1__R2__R3 ON node3_R1__R2__R3.a = node5_R4__R6.a AND node3_R1__R2__R3.b = node5_best.b AND node3_R1__R2__R3.c = node5_R4__R6.c WHERE node5_best.tag = 0) node6_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node6_R1__R2__R3__R4__R5__R6.a as a, node6_R1__R2__R3__R4__R5__R6.b as b, node6_R1__R2__R3__R4__R5__R6.c as c, node6_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node3_R1__R2__R3.a as a, node5_best.b as b, node3_R1__R2__R3.c as c, node5_best.d as d FROM node3_R1__R2__R3 JOIN node5_best ON node5_best.b = node3_R1__R2__R3.b WHERE node5_best.tag = 1) node6_R1__R2__R3__R4__R5__R6
);
