...
CREATE TEMP TABLE node6_R1__R5 AS SELECT R1.a as a, node5_best.b as b, node5_best.d as d FROM R1 JOIN node5_best ON node5_best.b = R1.b WHERE node5_best.tag = 0;
...
CREATE TEMP TABLE node6_best AS WITH
  cnt_R2 as (SELECT b, COUNT(*) as cnt FROM R2 GROUP BY b),
  best_R2 as (SELECT node6_R1__R5.a as a, node6_R1__R5.b as b, node6_R1__R5.d as d, 0 as tag, cnt_R2.cnt as cnt FROM node6_R1__R5, cnt_R2 WHERE cnt_R2.b = node6_R1__R5.b),
  cnt_R3__R4__R6 as (SELECT a,d, COUNT(*) as cnt FROM node5_R3__R4__R6 GROUP BY a,d),
  best_R3__R4__R6 as (SELECT best_R2.a as a, best_R2.b as b, best_R2.d as d, CASE WHEN best_R2.cnt < cnt_R3__R4__R6.cnt THEN best_R2.tag ELSE 1 END as tag,CASE WHEN best_R2.cnt < cnt_R3__R4__R6.cnt THEN best_R2.cnt ELSE cnt_R3__R4__R6.cnt END as cnt FROM best_R2, cnt_R3__R4__R6 WHERE cnt_R3__R4__R6.a = best_R2.a AND cnt_R3__R4__R6.d = best_R2.d)
SELECT a, b, d, tag FROM best_R3__R4__R6;
SELECT COUNT(*) FROM (
...
UNION ALL
SELECT node8_R1__R2__R3__R4__R5__R6.a as a, node8_R1__R2__R3__R4__R5__R6.b as b, node8_R1__R2__R3__R4__R5__R6.c as c, node8_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node5_R3__R4__R6.a as a, node5_best.b as b, node5_R3__R4__R6.c as c, node5_best.d as d FROM node5_R3__R4__R6 JOIN node5_best ON node5_best.d = node5_R3__R4__R6.d SEMI JOIN R1 ON R1.a = node5_R3__R4__R6.a AND R1.b = node5_best.b WHERE node5_best.tag = 1) node8_R1__R2__R3__R4__R5__R6
UNION ALL
...
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node6_best.a as a, node6_best.b as b, node6_best.d as d, R2.c as c FROM R2 JOIN node6_best ON node6_best.b = R2.b WHERE node6_best.tag = 0) node7_R1__R2__R3__R4__R5__R6
UNION ALL
SELECT node7_R1__R2__R3__R4__R5__R6.a as a, node7_R1__R2__R3__R4__R5__R6.b as b, node7_R1__R2__R3__R4__R5__R6.c as c, node7_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node6_best.a as a, node6_best.b as b, node6_best.d as d, node5_R3__R4__R6.c as c FROM node5_R3__R4__R6 JOIN node6_best ON node6_best.a = node5_R3__R4__R6.a AND node6_best.d = node5_R3__R4__R6.d SEMI JOIN R2 ON R2.b = node6_best.b AND R2.c = node5_R3__R4__R6.c WHERE node6_best.tag = 1) node7_R1__R2__R3__R4__R5__R6
);
