...
CREATE TEMP TABLE node5_R3__R4__R6 AS SELECT node0_best.a as a, node0_best.c as c, R6.d as d FROM R6 JOIN node0_best ON node0_best.c = R6.c WHERE node0_best.tag = 1;
...
CREATE TEMP TABLE node3_R5__R6 AS SELECT node1_best.b as b, node1_best.d as d, R6.c as c FROM R6 JOIN node1_best ON node1_best.d = R6.d WHERE node1_best.tag = 1;
...
CREATE TEMP TABLE node3_best AS WITH
  ...
  best_R1__R2__R3 as (SELECT node3_R5__R6.b as b, node3_R5__R6.d as d, node3_R5__R6.c as c, 0 as tag, cnt_R1__R2__R3.cnt as cnt FROM node3_R5__R6, cnt_R1__R2__R3 WHERE cnt_R1__R2__R3.b = node3_R5__R6.b AND cnt_R1__R2__R3.c = node3_R5__R6.c),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4__R5__R6.a as a, node2_R1__R2__R3__R4__R5__R6.b as b, node2_R1__R2__R3__R4__R5__R6.c as c, node2_R1__R2__R3__R4__R5__R6.d as d FROM (SELECT node1_R1__R2__R3.a as a, node1_best.b as b, node1_R1__R2__R3.c as c, node1_best.d as d FROM node1_R1__R2__R3 JOIN node1_best ON node1_best.b = node1_R1__R2__R3.b SEMI JOIN R6 ON R6.c = node1_R1__R2__R3.c AND R6.d = node1_best.d WHERE node1_best.tag = 0) node2_R1__R2__R3__R4__R5__R6
UNION ALL
