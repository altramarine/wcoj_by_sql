...
UNION ALL
SELECT node1_R1__R2__R3.x as x, node1_R1__R2__R3.y as y, node1_R1__R2__R3.z as z FROM (SELECT node0_best.x as x, node0_best.y as y, R2.z as z FROM R2 JOIN node0_best ON node0_best.y = R2.y SEMI JOIN R3 ON R3.z = R2.z AND R3.x = node0_best.x WHERE node0_best.tag = 1) node1_R1__R2__R3
);
