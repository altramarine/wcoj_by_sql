...
-- | R4 [R3, R1__R2]
-- | [4] R1__R2(a, b, c), R3__R4(c, d, a) [acyclic]
...
CREATE TEMP TABLE node1_best AS WITH
  ...
  best_R3 as (SELECT node1_R1__R4.a as a, node1_R1__R4.b as b, node1_R1__R4.d as d, 0 as tag, cnt_R3.cnt as cnt FROM node1_R1__R4, cnt_R3 WHERE cnt_R3.d = node1_R1__R4.d),
  cnt_R2 as (SELECT b, COUNT(*) as cnt FROM R2 GROUP BY b),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_best.d as d, R3.c as c FROM R3 JOIN node1_best ON node1_best.d = R3.d SEMI JOIN R2 ON R2.b = node1_best.b AND R2.c = R3.c WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_best.d as d, R2.c as c FROM R2 JOIN node1_best ON node1_best.b = R2.b SEMI JOIN R3 ON R3.c = R2.c AND R3.d = node1_best.d WHERE node1_best.tag = 1) node2_R1__R2__R3__R4
UNION ALL
SELECT node4_R3__R4.a as a, node3_R1__R2.b as b, node4_R3__R4.c as c, node4_R3__R4.d as d FROM (SELECT R3.c as c, node3_best.d as d, node3_best.a as a FROM R3 JOIN node3_best ON node3_best.d = R3.d WHERE node3_best.tag = 0) node4_R3__R4 JOIN node3_R1__R2 ON node3_R1__R2.a = node4_R3__R4.a AND node3_R1__R2.c = node4_R3__R4.c
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node3_best.a as a, node3_R1__R2.b as b, node3_R1__R2.c as c, node3_best.d as d FROM node3_R1__R2 JOIN node3_best ON node3_best.a = node3_R1__R2.a SEMI JOIN R3 ON R3.c = node3_R1__R2.c AND R3.d = node3_best.d WHERE node3_best.tag = 1) node5_R1__R2__R3__R4
);
