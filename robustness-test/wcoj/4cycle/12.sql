...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R1 as (SELECT a, COUNT(*) as cnt FROM R1 GROUP BY a),
  best_R1 as (SELECT node4_R3__R4.c as c, node4_R3__R4.d as d, node4_R3__R4.a as a, 0 as tag, cnt_R1.cnt as cnt FROM node4_R3__R4, cnt_R1 WHERE cnt_R1.a = node4_R3__R4.a),
  cnt_R2 as (SELECT c, COUNT(*) as cnt FROM R2 GROUP BY c),
...
SELECT COUNT(*) FROM (
SELECT node1_R1__R4.a as a, node2_R2__R3.b as b, node2_R2__R3.c as c, node2_R2__R3.d as d FROM (SELECT R2.b as b, node1_best.c as c, node1_best.d as d FROM R2 JOIN node1_best ON node1_best.c = R2.c WHERE node1_best.tag = 0) node2_R2__R3 JOIN node1_R1__R4 ON node1_R1__R4.b = node2_R2__R3.b AND node1_R1__R4.d = node2_R2__R3.d
UNION ALL
SELECT node3_R1__R2__R3__R4.a as a, node3_R1__R2__R3__R4.b as b, node3_R1__R2__R3__R4.c as c, node3_R1__R2__R3__R4.d as d FROM (SELECT node1_R1__R4.a as a, node1_R1__R4.b as b, node1_best.d as d, node1_best.c as c FROM node1_R1__R4 JOIN node1_best ON node1_best.d = node1_R1__R4.d SEMI JOIN R2 ON R2.b = node1_R1__R4.b AND R2.c = node1_best.c WHERE node1_best.tag = 1) node3_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, R1.b as b, node4_best.c as c, node4_best.d as d FROM R1 JOIN node4_best ON node4_best.a = R1.a SEMI JOIN R2 ON R2.b = R1.b AND R2.c = node4_best.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, R2.b as b, node4_best.c as c, node4_best.d as d FROM R2 JOIN node4_best ON node4_best.c = R2.c SEMI JOIN R1 ON R1.a = node4_best.a AND R1.b = R2.b WHERE node4_best.tag = 1) node5_R1__R2__R3__R4
);
