...
SELECT COUNT(*) FROM (
SELECT node2_R3__R4.a as a, node1_R1__R2.b as b, node2_R3__R4.c as c, node2_R3__R4.d as d FROM (SELECT R3.c as c, node1_best.d as d, node1_best.a as a FROM R3 JOIN node1_best ON node1_best.d = R3.d WHERE node1_best.tag = 0) node2_R3__R4 JOIN node1_R1__R2 ON node1_R1__R2.a = node2_R3__R4.a AND node1_R1__R2.c = node2_R3__R4.c
UNION ALL
SELECT node3_R1__R2__R3__R4.a as a, node3_R1__R2__R3__R4.b as b, node3_R1__R2__R3__R4.c as c, node3_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_R1__R2.b as b, node1_R1__R2.c as c, node1_best.d as d FROM node1_R1__R2 JOIN node1_best ON node1_best.a = node1_R1__R2.a SEMI JOIN R3 ON R3.c = node1_R1__R2.c AND R3.d = node1_best.d WHERE node1_best.tag = 1) node3_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_R1__R4.a as a, node4_best.b as b, node4_R1__R4.d as d, node4_best.c as c FROM node4_R1__R4 JOIN node4_best ON node4_best.b = node4_R1__R4.b SEMI JOIN R3 ON R3.c = node4_best.c AND R3.d = node4_R1__R4.d WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node4_R1__R4.a as a, node6_R2__R3.b as b, node6_R2__R3.c as c, node6_R2__R3.d as d FROM (SELECT node4_best.b as b, node4_best.c as c, R3.d as d FROM R3 JOIN node4_best ON node4_best.c = R3.c WHERE node4_best.tag = 1) node6_R2__R3 JOIN node4_R1__R4 ON node4_R1__R4.b = node6_R2__R3.b AND node4_R1__R4.d = node6_R2__R3.d
);
