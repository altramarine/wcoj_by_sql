...
CREATE TEMP TABLE node4_R3__R4 AS SELECT node0_best.c as c, node0_best.d as d, R4.a as a FROM R4 JOIN node0_best ON node0_best.d = R4.d WHERE node0_best.tag = 1;
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_R2__R3.b as b, node1_R2__R3.c as c, node1_best.d as d FROM node1_R2__R3 JOIN node1_best ON node1_best.d = node1_R2__R3.d SEMI JOIN R1 ON R1.a = node1_best.a AND R1.b = node1_R2__R3.b WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node3_R1__R4.a as a, node3_R1__R4.b as b, node1_R2__R3.c as c, node3_R1__R4.d as d FROM (SELECT node1_best.a as a, R1.b as b, node1_best.d as d FROM R1 JOIN node1_best ON node1_best.a = R1.a WHERE node1_best.tag = 1) node3_R1__R4 JOIN node1_R2__R3 ON node1_R2__R3.b = node3_R1__R4.b AND node1_R2__R3.d = node3_R1__R4.d
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_R3__R4.c as c, node4_R3__R4.d as d FROM node4_R3__R4 JOIN node4_best ON node4_best.a = node4_R3__R4.a SEMI JOIN R2 ON R2.b = node4_best.b AND R2.c = node4_R3__R4.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node6_R1__R2.a as a, node6_R1__R2.b as b, node6_R1__R2.c as c, node4_R3__R4.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, R2.c as c FROM R2 JOIN node4_best ON node4_best.b = R2.b WHERE node4_best.tag = 1) node6_R1__R2 JOIN node4_R3__R4 ON node4_R3__R4.c = node6_R1__R2.c AND node4_R3__R4.a = node6_R1__R2.a
);
