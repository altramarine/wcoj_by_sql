...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R4 as (SELECT d, COUNT(*) as cnt FROM R4 GROUP BY d),
  best_R4 as (SELECT node4_R2__R3.b as b, node4_R2__R3.c as c, node4_R2__R3.d as d, 0 as tag, cnt_R4.cnt as cnt FROM node4_R2__R3, cnt_R4 WHERE cnt_R4.d = node4_R2__R3.d),
  cnt_R1 as (SELECT b, COUNT(*) as cnt FROM R1 GROUP BY b),
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT R4.a as a, node4_best.b as b, node4_best.c as c, node4_best.d as d FROM R4 JOIN node4_best ON node4_best.d = R4.d SEMI JOIN R1 ON R1.a = R4.a AND R1.b = node4_best.b WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT R1.a as a, node4_best.b as b, node4_best.c as c, node4_best.d as d FROM R1 JOIN node4_best ON node4_best.b = R1.b SEMI JOIN R4 ON R4.d = node4_best.d AND R4.a = R1.a WHERE node4_best.tag = 1) node5_R1__R2__R3__R4
);
