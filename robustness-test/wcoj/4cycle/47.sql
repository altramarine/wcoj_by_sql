...
UNION ALL
SELECT node3_R1__R4.a as a, node4_R2__R3.b as b, node4_R2__R3.c as c, node4_R2__R3.d as d FROM (SELECT R2.b as b, node3_best.c as c, node3_best.d as d FROM R2 JOIN node3_best ON node3_best.c = R2.c WHERE node3_best.tag = 0) node4_R2__R3 JOIN node3_R1__R4 ON node3_R1__R4.b = node4_R2__R3.b AND node3_R1__R4.d = node4_R2__R3.d
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node3_R1__R4.a as a, node3_R1__R4.b as b, node3_best.d as d, node3_best.c as c FROM node3_R1__R4 JOIN node3_best ON node3_best.d = node3_R1__R4.d SEMI JOIN R2 ON R2.b = node3_R1__R4.b AND R2.c = node3_best.c WHERE node3_best.tag = 1) node5_R1__R2__R3__R4
);
