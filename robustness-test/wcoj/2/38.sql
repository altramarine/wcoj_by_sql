...
CREATE TEMP TABLE node3_best AS WITH
  ...
  best_R3 as (SELECT node3_R2__R4.b as b, node3_R2__R4.c as c, node3_R2__R4.d as d, 0 as tag, cnt_R3.cnt as cnt FROM node3_R2__R4, cnt_R3 WHERE cnt_R3.d = node3_R2__R4.d),
  cnt_R1 as (SELECT b, COUNT(*) as cnt FROM R1 GROUP BY b),
...
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT R3.a as a, node3_best.b as b, node3_best.c as c, node3_best.d as d FROM R3 JOIN node3_best ON node3_best.d = R3.d SEMI JOIN R1 ON R1.a = R3.a AND R1.b = node3_best.b WHERE node3_best.tag = 0) node4_R1__R2__R3__R4
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT R1.a as a, node3_best.b as b, node3_best.c as c, node3_best.d as d FROM R1 JOIN node3_best ON node3_best.b = R1.b SEMI JOIN R3 ON R3.a = R1.a AND R3.d = node3_best.d WHERE node3_best.tag = 1) node4_R1__R2__R3__R4
);
