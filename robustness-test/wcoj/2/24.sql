...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R2__R4 as (SELECT d, COUNT(*) as cnt FROM node4_R2__R4 GROUP BY d),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_R3__R4.d as d, node1_R3__R4.c as c FROM node1_R3__R4 JOIN node1_best ON node1_best.a = node1_R3__R4.a SEMI JOIN R2 ON R2.b = node1_best.b AND R2.c = node1_R3__R4.c WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, node4_R2__R4.b as b, node4_R2__R4.c as c, node4_best.d as d FROM node4_R2__R4 JOIN node4_best ON node4_best.d = node4_R2__R4.d SEMI JOIN R1 ON R1.a = node4_best.a AND R1.b = node4_R2__R4.b WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node6_R1__R3.a as a, node6_R1__R3.b as b, node4_R2__R4.c as c, node6_R1__R3.d as d FROM (SELECT node4_best.a as a, R1.b as b, node4_best.d as d FROM R1 JOIN node4_best ON node4_best.a = R1.a WHERE node4_best.tag = 1) node6_R1__R3 JOIN node4_R2__R4 ON node4_R2__R4.b = node6_R1__R3.b AND node4_R2__R4.d = node6_R1__R3.d
);
