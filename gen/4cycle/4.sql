...
CREATE TEMP TABLE node1_best AS WITH
  ...
  best_R2__R3 as (SELECT best_R1.d as d, best_R1.a as a, CASE WHEN best_R1.cnt < cnt_R2__R3.cnt THEN best_R1.tag ELSE 1 END as tag,CASE WHEN best_R1.cnt < cnt_R2__R3.cnt THEN best_R1.cnt ELSE cnt_R2__R3.cnt END as cnt FROM best_R1, cnt_R2__R3 WHERE cnt_R2__R3.d = best_R1.d)
SELECT d, a, tag FROM best_R2__R3;
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R4.a as a, node2_R1__R4.b as b, node1_R2__R3.c as c, node2_R1__R4.d as d FROM (SELECT node1_best.a as a, R1.b as b, node1_best.d as d FROM R1 JOIN node1_best ON node1_best.a = R1.a WHERE node1_best.tag = 0) node2_R1__R4 JOIN node1_R2__R3 ON node1_R2__R3.b = node2_R1__R4.b AND node1_R2__R3.d = node2_R1__R4.d
UNION ALL
SELECT node3_R1__R2__R3__R4.a as a, node3_R1__R2__R3__R4.b as b, node3_R1__R2__R3__R4.c as c, node3_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_R2__R3.b as b, node1_R2__R3.c as c, node1_best.d as d FROM node1_R2__R3 JOIN node1_best ON node1_best.d = node1_R2__R3.d SEMI JOIN R1 ON R1.a = node1_best.a AND R1.b = node1_R2__R3.b WHERE node1_best.tag = 1) node3_R1__R2__R3__R4
UNION ALL
