...
-- | [6] R1__R4(a, b, d), R2__R3(b, c, d) [acyclic]
...
CREATE TEMP TABLE node4_R2__R3 AS SELECT R2.b as b, node0_best.c as c, node0_best.d as d FROM R2 JOIN node0_best ON node0_best.c = R2.c WHERE node0_best.tag = 1;
...
CREATE TEMP TABLE node4_best AS WITH
  ...
  best_R2__R3 as (SELECT R4.d as d, R4.a as a, 0 as tag, cnt_R2__R3.cnt as cnt FROM R4, cnt_R2__R3 WHERE cnt_R2__R3.d = R4.d),
  cnt_R1 as (SELECT a, COUNT(*) as cnt FROM R1 GROUP BY a),
  best_R1 as (SELECT best_R2__R3.d as d, best_R2__R3.a as a, CASE WHEN best_R2__R3.cnt < cnt_R1.cnt THEN best_R2__R3.tag ELSE 1 END as tag,CASE WHEN best_R2__R3.cnt < cnt_R1.cnt THEN best_R2__R3.cnt ELSE cnt_R1.cnt END as cnt FROM best_R2__R3, cnt_R1 WHERE cnt_R1.a = best_R2__R3.a)
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, node4_R2__R3.b as b, node4_R2__R3.c as c, node4_best.d as d FROM node4_R2__R3 JOIN node4_best ON node4_best.d = node4_R2__R3.d SEMI JOIN R1 ON R1.a = node4_best.a AND R1.b = node4_R2__R3.b WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node6_R1__R4.a as a, node6_R1__R4.b as b, node4_R2__R3.c as c, node6_R1__R4.d as d FROM (SELECT node4_best.a as a, R1.b as b, node4_best.d as d FROM R1 JOIN node4_best ON node4_best.a = R1.a WHERE node4_best.tag = 1) node6_R1__R4 JOIN node4_R2__R3 ON node4_R2__R3.b = node6_R1__R4.b AND node4_R2__R3.d = node6_R1__R4.d
);
