...
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT node3_best.a as a, node3_R2__R3.b as b, node3_R2__R3.c as c, node3_best.d as d FROM node3_R2__R3 JOIN node3_best ON node3_best.d = node3_R2__R3.d SEMI JOIN R1 ON R1.a = node3_best.a AND R1.b = node3_R2__R3.b WHERE node3_best.tag = 0) node4_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R4.a as a, node5_R1__R4.b as b, node3_R2__R3.c as c, node5_R1__R4.d as d FROM (SELECT node3_best.a as a, R1.b as b, node3_best.d as d FROM R1 JOIN node3_best ON node3_best.a = R1.a WHERE node3_best.tag = 1) node5_R1__R4 JOIN node3_R2__R3 ON node3_R2__R3.b = node5_R1__R4.b AND node3_R2__R3.d = node5_R1__R4.d
);
