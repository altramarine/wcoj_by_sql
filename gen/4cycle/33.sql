...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2.a as a, node2_R1__R2.b as b, node2_R1__R2.c as c, node1_R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, R2.c as c FROM R2 JOIN node1_best ON node1_best.b = R2.b WHERE node1_best.tag = 0) node2_R1__R2 JOIN node1_R3__R4 ON node1_R3__R4.c = node2_R1__R2.c AND node1_R3__R4.a = node2_R1__R2.a
UNION ALL
SELECT node3_R1__R2__R3__R4.a as a, node3_R1__R2__R3__R4.b as b, node3_R1__R2__R3__R4.c as c, node3_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_R3__R4.c as c, node1_R3__R4.d as d FROM node1_R3__R4 JOIN node1_best ON node1_best.a = node1_R3__R4.a SEMI JOIN R2 ON R2.b = node1_best.b AND R2.c = node1_R3__R4.c WHERE node1_best.tag = 1) node3_R1__R2__R3__R4
UNION ALL
