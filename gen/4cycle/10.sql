...
UNION ALL
SELECT node4_R1__R2.a as a, node4_R1__R2.b as b, node4_R1__R2.c as c, node3_R3__R4.d as d FROM (SELECT R1.a as a, node3_best.b as b, node3_best.c as c FROM R1 JOIN node3_best ON node3_best.b = R1.b WHERE node3_best.tag = 0) node4_R1__R2 JOIN node3_R3__R4 ON node3_R3__R4.c = node4_R1__R2.c AND node3_R3__R4.a = node4_R1__R2.a
UNION ALL
