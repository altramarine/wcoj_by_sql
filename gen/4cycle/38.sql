...
CREATE TEMP TABLE node3_R2__R3 AS SELECT node0_best.b as b, node0_best.c as c, R3.d as d FROM R3 JOIN node0_best ON node0_best.c = R3.c WHERE node0_best.tag = 1;
...
CREATE TEMP TABLE node3_best AS WITH
  ...
  best_R4 as (SELECT node3_R2__R3.b as b, node3_R2__R3.c as c, node3_R2__R3.d as d, 0 as tag, cnt_R4.cnt as cnt FROM node3_R2__R3, cnt_R4 WHERE cnt_R4.d = node3_R2__R3.d),
  cnt_R1 as (SELECT b, COUNT(*) as cnt FROM R1 GROUP BY b),
...
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT R1.a as a, node3_best.b as b, node3_best.c as c, node3_best.d as d FROM R1 JOIN node3_best ON node3_best.b = R1.b SEMI JOIN R4 ON R4.d = node3_best.d AND R4.a = R1.a WHERE node3_best.tag = 1) node4_R1__R2__R3__R4
);
