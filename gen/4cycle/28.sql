...
CREATE TEMP TABLE node1_best AS WITH
  ...
  cnt_R4 as (SELECT a, COUNT(*) as cnt FROM R4 GROUP BY a),
  best_R4 as (SELECT best_R3.a as a, best_R3.b as b, best_R3.c as c, CASE WHEN best_R3.cnt < cnt_R4.cnt THEN best_R3.tag ELSE 1 END as tag,CASE WHEN best_R3.cnt < cnt_R4.cnt THEN best_R3.cnt ELSE cnt_R4.cnt END as cnt FROM best_R3, cnt_R4 WHERE cnt_R4.a = best_R3.a)
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_best.c as c, R3.d as d FROM R3 JOIN node1_best ON node1_best.c = R3.c SEMI JOIN R4 ON R4.d = R3.d AND R4.a = node1_best.a WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.b as b, node1_best.c as c, R4.d as d FROM R4 JOIN node1_best ON node1_best.a = R4.a SEMI JOIN R3 ON R3.c = node1_best.c AND R3.d = R4.d WHERE node1_best.tag = 1) node2_R1__R2__R3__R4
UNION ALL
SELECT node3_R1__R4.a as a, node4_R2__R3.b as b, node4_R2__R3.c as c, node4_R2__R3.d as d FROM (SELECT node3_best.b as b, node3_best.c as c, R3.d as d FROM R3 JOIN node3_best ON node3_best.c = R3.c WHERE node3_best.tag = 0) node4_R2__R3 JOIN node3_R1__R4 ON node3_R1__R4.b = node4_R2__R3.b AND node3_R1__R4.d = node4_R2__R3.d
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node3_R1__R4.a as a, node3_best.b as b, node3_R1__R4.d as d, node3_best.c as c FROM node3_R1__R4 JOIN node3_best ON node3_best.b = node3_R1__R4.b SEMI JOIN R3 ON R3.c = node3_best.c AND R3.d = node3_R1__R4.d WHERE node3_best.tag = 1) node5_R1__R2__R3__R4
);
