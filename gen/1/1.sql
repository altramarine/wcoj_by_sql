...
SELECT COUNT(*) FROM (
SELECT node1_R1__R2__R3.x as x, node1_R1__R2__R3.y as y, node1_R1__R2__R3.z as z FROM (SELECT R1.x as x, node0_best.y as y, node0_best.z as z FROM R1 JOIN node0_best ON node0_best.y = R1.y SEMI JOIN R3 ON R3.x = R1.x AND R3.z = node0_best.z WHERE node0_best.tag = 0) node1_R1__R2__R3
UNION ALL
