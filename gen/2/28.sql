...
CREATE TEMP TABLE node3_best AS WITH
  ...
  cnt_R1__R3 as (SELECT b, COUNT(*) as cnt FROM node3_R1__R3 GROUP BY b),
...
UNION ALL
SELECT node3_R1__R3.a as a, node4_R2__R4.b as b, node4_R2__R4.c as c, node4_R2__R4.d as d FROM (SELECT node3_best.b as b, node3_best.c as c, R4.d as d FROM R4 JOIN node3_best ON node3_best.c = R4.c WHERE node3_best.tag = 0) node4_R2__R4 JOIN node3_R1__R3 ON node3_R1__R3.b = node4_R2__R4.b AND node3_R1__R3.d = node4_R2__R4.d
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node3_R1__R3.a as a, node3_best.b as b, node3_R1__R3.d as d, node3_best.c as c FROM node3_R1__R3 JOIN node3_best ON node3_best.b = node3_R1__R3.b SEMI JOIN R4 ON R4.d = node3_R1__R3.d AND R4.c = node3_best.c WHERE node3_best.tag = 1) node5_R1__R2__R3__R4
);
