...
CREATE TEMP TABLE node4_best AS WITH
  ...
  cnt_R1__R3 as (SELECT d, COUNT(*) as cnt FROM node4_R1__R3 GROUP BY d),
...
UNION ALL
SELECT node4_R1__R3.a as a, node5_R2__R4.b as b, node5_R2__R4.c as c, node5_R2__R4.d as d FROM (SELECT R2.b as b, node4_best.c as c, node4_best.d as d FROM R2 JOIN node4_best ON node4_best.c = R2.c WHERE node4_best.tag = 0) node5_R2__R4 JOIN node4_R1__R3 ON node4_R1__R3.b = node5_R2__R4.b AND node4_R1__R3.d = node5_R2__R4.d
UNION ALL
SELECT node6_R1__R2__R3__R4.a as a, node6_R1__R2__R3__R4.b as b, node6_R1__R2__R3__R4.c as c, node6_R1__R2__R3__R4.d as d FROM (SELECT node4_R1__R3.a as a, node4_R1__R3.b as b, node4_best.d as d, node4_best.c as c FROM node4_R1__R3 JOIN node4_best ON node4_best.d = node4_R1__R3.d SEMI JOIN R2 ON R2.b = node4_R1__R3.b AND R2.c = node4_best.c WHERE node4_best.tag = 1) node6_R1__R2__R3__R4
);
