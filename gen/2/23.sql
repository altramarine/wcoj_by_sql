...
CREATE TEMP TABLE node1_best AS WITH
  cnt_R1 as (SELECT a, COUNT(*) as cnt FROM R1 GROUP BY a),
  best_R1 as (SELECT node1_R3__R4.a as a, node1_R3__R4.d as d, node1_R3__R4.c as c, 0 as tag, cnt_R1.cnt as cnt FROM node1_R3__R4, cnt_R1 WHERE cnt_R1.a = node1_R3__R4.a),
...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, R1.b as b, node1_best.d as d, node1_best.c as c FROM R1 JOIN node1_best ON node1_best.a = R1.a SEMI JOIN R2 ON R2.b = R1.b AND R2.c = node1_best.c WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, R2.b as b, node1_best.d as d, node1_best.c as c FROM R2 JOIN node1_best ON node1_best.c = R2.c SEMI JOIN R1 ON R1.a = node1_best.a AND R1.b = R2.b WHERE node1_best.tag = 1) node2_R1__R2__R3__R4
UNION ALL
SELECT node4_R1__R2__R3__R4.a as a, node4_R1__R2__R3__R4.b as b, node4_R1__R2__R3__R4.c as c, node4_R1__R2__R3__R4.d as d FROM (SELECT node3_R1__R3.a as a, node3_best.b as b, node3_R1__R3.d as d, node3_best.c as c FROM node3_R1__R3 JOIN node3_best ON node3_best.b = node3_R1__R3.b SEMI JOIN R4 ON R4.d = node3_R1__R3.d AND R4.c = node3_best.c WHERE node3_best.tag = 0) node4_R1__R2__R3__R4
UNION ALL
SELECT node3_R1__R3.a as a, node5_R2__R4.b as b, node5_R2__R4.c as c, node5_R2__R4.d as d FROM (SELECT node3_best.b as b, node3_best.c as c, R4.d as d FROM R4 JOIN node3_best ON node3_best.c = R4.c WHERE node3_best.tag = 1) node5_R2__R4 JOIN node3_R1__R3 ON node3_R1__R3.b = node5_R2__R4.b AND node3_R1__R3.d = node5_R2__R4.d
);
