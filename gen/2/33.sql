...
CREATE TEMP TABLE node4_best AS WITH
  cnt_R2 as (SELECT b, COUNT(*) as cnt FROM R2 GROUP BY b),
  best_R2 as (SELECT node4_R1__R3.a as a, node4_R1__R3.b as b, node4_R1__R3.d as d, 0 as tag, cnt_R2.cnt as cnt FROM node4_R1__R3, cnt_R2 WHERE cnt_R2.b = node4_R1__R3.b),
  cnt_R4 as (SELECT d, COUNT(*) as cnt FROM R4 GROUP BY d),
  best_R4 as (SELECT best_R2.a as a, best_R2.b as b, best_R2.d as d, CASE WHEN best_R2.cnt < cnt_R4.cnt THEN best_R2.tag ELSE 1 END as tag,CASE WHEN best_R2.cnt < cnt_R4.cnt THEN best_R2.cnt ELSE cnt_R4.cnt END as cnt FROM best_R2, cnt_R4 WHERE cnt_R4.d = best_R2.d)
...
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R2.c as c FROM R2 JOIN node4_best ON node4_best.b = R2.b SEMI JOIN R4 ON R4.d = node4_best.d AND R4.c = R2.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4
UNION ALL
SELECT node5_R1__R2__R3__R4.a as a, node5_R1__R2__R3__R4.b as b, node5_R1__R2__R3__R4.c as c, node5_R1__R2__R3__R4.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_best.d as d, R4.c as c FROM R4 JOIN node4_best ON node4_best.d = R4.d SEMI JOIN R2 ON R2.b = node4_best.b AND R2.c = R4.c WHERE node4_best.tag = 1) node5_R1__R2__R3__R4
);
