...
SELECT COUNT(*) FROM (
SELECT node2_R1__R2__R3__R4.a as a, node2_R1__R2__R3__R4.b as b, node2_R1__R2__R3__R4.c as c, node2_R1__R2__R3__R4.d as d FROM (SELECT node1_best.a as a, node1_R1__R2.b as b, node1_R1__R2.c as c, node1_best.d as d FROM node1_R1__R2 JOIN node1_best ON node1_best.a = node1_R1__R2.a SEMI JOIN R4 ON R4.d = node1_best.d AND R4.c = node1_R1__R2.c WHERE node1_best.tag = 0) node2_R1__R2__R3__R4
UNION ALL
SELECT node3_R3__R4.a as a, node1_R1__R2.b as b, node3_R3__R4.c as c, node3_R3__R4.d as d FROM (SELECT node1_best.a as a, node1_best.d as d, R4.c as c FROM R4 JOIN node1_best ON node1_best.d = R4.d WHERE node1_best.tag = 1) node3_R3__R4 JOIN node1_R1__R2 ON node1_R1__R2.a = node3_R3__R4.a AND node1_R1__R2.c = node3_R3__R4.c
UNION ALL
