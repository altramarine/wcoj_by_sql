...
-- [4] group: R1(a, b), R2__R4__R5(b, c, d), R3(a, c)
-- [4] enter split (e.g. "R1 R2 R3"): R1 R2__R4__R5 R3
-- [4] start: R1  split: R2__R4__R5 vs R3
-- [4] R1 join w/ R2__R4__R5: R1__R2__R3__R4__R5(a, b, c, d)
-- [4] R1 join w/ R3: R1__R3(a, b, c), R2__R4__R5(b, c, d)
...
CREATE TEMP TABLE node4_R2__R4__R5 AS SELECT node0_best.b as b, node0_best.c as c, R4.d as d FROM R4 JOIN node0_best ON node0_best.b = R4.b SEMI JOIN R5 ON R5.c = node0_best.c AND R5.d = R4.d WHERE node0_best.tag = 2
UNION ALL
...
UNION ALL
SELECT node5_R1__R2__R3__R4__R5.a as a, node5_R1__R2__R3__R4__R5.b as b, node5_R1__R2__R3__R4__R5.c as c, node5_R1__R2__R3__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, node4_R2__R4__R5.c as c, node4_R2__R4__R5.d as d FROM node4_R2__R4__R5 JOIN node4_best ON node4_best.b = node4_R2__R4__R5.b SEMI JOIN R3 ON R3.a = node4_best.a AND R3.c = node4_R2__R4__R5.c WHERE node4_best.tag = 0) node5_R1__R2__R3__R4__R5
UNION ALL
SELECT node6_R1__R3.a as a, node6_R1__R3.b as b, node6_R1__R3.c as c, node4_R2__R4__R5.d as d FROM (SELECT node4_best.a as a, node4_best.b as b, R3.c as c FROM R3 JOIN node4_best ON node4_best.a = R3.a WHERE node4_best.tag = 1) node6_R1__R3 JOIN node4_R2__R4__R5 ON node4_R2__R4__R5.b = node6_R1__R3.b AND node4_R2__R4__R5.c = node6_R1__R3.c
);